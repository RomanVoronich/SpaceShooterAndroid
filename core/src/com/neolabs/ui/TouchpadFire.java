 ...
 * @author Josh Street
 */
public class TouchpadFire extends Widget {
     ...
     */
    public TouchpadFire(float deadzoneRadius, Skin skin) {
     ...
     * @param deadzoneRadius The distance in pixels from the center of the touchpad required for the knob to be moved.
     */
    public TouchpadFire(float deadzoneRadius, Skin skin, String styleName) {
     ...
     * @param deadzoneRadius The distance in pixels from the center of the touchpad required for the knob to be moved.
     */
    public TouchpadFire(float deadzoneRadius, TouchpadStyle style) {
