        ...
        new AsyncTask<Void, Void, Integer>() {
            ...
            protected Integer doInBackground(Void... params) {
                ...
                try {
                    ...
                    Log.d(mDebugTag, "start getSku");

                    Bundle ownedItems = mService.getPurchases(3, mContext.getPackageName(), "subs", null);
                    ...
                    if (response == 0) {
                        ...
                        for (int i = 0; i < purchaseDataList.size(); ++i) {
                            ...
                            if (sku.equals("premium")) return 1;

                            Log.d(mDebugTag, "sku = " + (sku));
                            Log.d(mDebugTag, "purchaseData = " + (purchaseData));
                            Log.d(mDebugTag, "signature = " + (signature));
                            // do something with this purchase information
                            // e.g. display the updated list of products owned by user
                        }
                        Log.d(mDebugTag, "purchaseDataList.size = " + (purchaseDataList.size()));
